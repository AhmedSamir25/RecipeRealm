                                ...
                                if (emailController.text.isNotEmpty &&
                                    ...
                                    nameController.text.isNotEmpty) {
                                      ...
                                      ScaffoldMessenger.of(context).showSnackBar(
                                        const SnackBar(backgroundColor: Colors.red ,content: Text('doneeeee',style: TextStyle(color: Colors.black),)));
                                    }
                              },
                              child: Row(
